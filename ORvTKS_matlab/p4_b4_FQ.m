...
rate1 = floor(velikost_out_prometa/4);
rate2 = floor(velikost_out_prometa/4);
rate3 = floor(velikost_out_prometa/4);
rate4 = floor(velikost_out_prometa/4);
...
narisi_izhodni_promet(5,izhodni_cas,izhodni_promet,'Fair Queue');
